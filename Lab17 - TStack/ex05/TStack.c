...
{
    TStackNum *st;
    st = malloc(sizeof(TStackNum));
    if(st == NULL)
        return NULL;
    st->data = malloc(sizeof(int *));
    if(st->data == NULL){
        free(st);
        return NULL;
    }
...
int stack_num_push(TStackNum *st, int s) //empilha
{   
    if(st == NULL)
        return INVALID_NULL_POINTER;
...
int stack_num_pop(TStackNum *st) //desempilha
{
    if(st == NULL)
        return INVALID_NULL_POINTER;
